...
class HorsesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create horse" do
    assert_difference('Horse.count') do
      post horses_url, params: { horse: { descrizione: @horse.descrizione, età: @horse.età, nome: @horse.nome, sesso: @horse.sesso } }
    end
  ...
  test "should update horse" do
    patch horse_url(@horse), params: { horse: { descrizione: @horse.descrizione, età: @horse.età, nome: @horse.nome, sesso: @horse.sesso } }
